...
# Pyarrow
# COPY ./pyarrow_0_11_0-37m-x86_64-alpine312.tar.gz /root/pyarrow_0_11_0-37m-x86_64-alpine312.tar.gz
# RUN set -ex \
#	&& tar xzvf /root/pyarrow_0_11_0-37m-x86_64-alpine312.tar.gz -C /usr/local/lib/python3.8/site-packages/ \
#	&& rm /root/pyarrow_0_11_0-37m-x86_64-alpine312.tar.gz
